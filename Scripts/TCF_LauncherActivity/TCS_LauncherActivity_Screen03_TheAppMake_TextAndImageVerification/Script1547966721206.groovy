...
Mobile.verifyElementVisible(findTestObject('ORF_LauncherActivity/ORF_LauncherActivity_Screen03_TheAppMake/android.widget.ImageView0'), 
    5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('ORF_LauncherActivity/ORF_LauncherActivity_Screen03_TheAppMake/android.widget.ImageView1'), 
    5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('ORF_LauncherActivity/ORF_LauncherActivity_Screen03_TheAppMake/android.widget.ImageView2'), 
    5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('ORF_LauncherActivity/ORF_LauncherActivity_Screen03_TheAppMake/android.widget.ImageView3'), 
    5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('ORF_LauncherActivity/ORF_LauncherActivity_Screen03_TheAppMake/android.widget.ImageView4'), 
    5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('ORF_LauncherActivity/ORF_LauncherActivity_Screen03_TheAppMake/android.widget.ImageView5'), 
    5, FailureHandling.CONTINUE_ON_FAILURE)
